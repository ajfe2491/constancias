    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="card bg-base-100 shadow-xl">
                <div class="card-body">
                    <h2 class="card-title">Editar Rol: {{ $role->name }}</h2>
                    ...
                    <form action="{{ route('roles.update', $role) }}" method="POST" class="space-y-4">
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="text" name="name" value="{{ old('name', $role->name) }}" class="input input-bordered w-full" required />
                        ...
                        <div class="form-control w-full">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                @foreach($permissions as $permission)
                                    <label class="label cursor-pointer justify-start gap-3 border border-base-200 rounded p-2 hover:bg-base-200">
